...
import com.potolochnik.app.data.ProjectStage
import com.potolochnik.app.databinding.FragmentInfoBinding
...
class InfoFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        // Всегда перечитываем свежий проект — вдруг пользователь добавил/изменил комнаты
    ...
    /**
     * Атомарное сохранение: читаем СВЕЖИЙ проект из хранилища,
     * применяем изменение только к нужному полю и сохраняем.
     * Комнаты, чертежи и смета никогда не затираются.
     */
    private fun saveField(update: (Project) -> Unit) {
        storage.updateProject(projectId, update)
        // Обновляем локальную копию чтобы UI был согласован
